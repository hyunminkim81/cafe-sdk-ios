...
[네이버 아이디로 로그인](https://developers.naver.com/apps/#/register?api=nvlogin)에 애플리케이션을 등록하고 받은 ClientId, ClientSecret 값을 세팅한다.

[네이버 카페를 개설](http://section.cafe.naver.com/)하고 얻은 카페 ID를 세팅한다.

[네이버 아이디로 로그인](https://developers.naver.com/apps/#/myapps)에 내 애플리케이션의 API 설정에 등록한 iOS URL Scheme을 세팅한다.
...
- [네이버 아이디 로그인-4.0.7](https://developers.naver.com/docs/login/sdks)
